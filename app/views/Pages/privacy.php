<div class="jumbotron">
  ...
  <p class="lead">Effective date: January 01, 2019</p>
</div>


<p><?=APP_AUTHOR;?> ("us", "we", or "our") operates the <?=APP_URL;?> website (the "Service").</p>
...
<p><?=APP_AUTHOR;?> uses the collected data for various purposes:</p>
<ul>
...
<p>
  If you are located outside <?=APP_LOCATION;?> and choose to provide information to us, please note that we transfer the data,
  including Personal Data, to <?=APP_LOCATION;?> and process it there.
</p>
<p>
...
<p>
  <?=APP_AUTHOR;?> will take all steps reasonably necessary to ensure that your data is treated securely and in accordance
...
<p><?=APP_AUTHOR;?> may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
<ul>
  <li>To comply with a legal obligation</li>
  <li>To protect and defend the rights or property of mvcTemplate</li>

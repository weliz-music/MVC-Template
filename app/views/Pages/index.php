...
<div class="container">
  <div class="row">
    ...
    <div class="col-md-6 my-3">
      ...
      <hr>
      <p>
        This MVC Template is built on PHP 7.0 and can be used on most web servers today. Just download, follow the
        instructions and you're set to start developing!
      </p>
    </div>
  </div>
</div>